...
int main(void)
{
  ...
  zeros(vector, ARRAY_LENGTH);

  escalar = 10;

  productoEscalar32(vectorIn32, vectorOut32, ARRAY_LENGTH, escalar);

  asm_zeros(vectorOut32, ARRAY_LENGTH);

  asm_productoEscalar32(vectorIn32, vectorOut32, ARRAY_LENGTH, escalar);
